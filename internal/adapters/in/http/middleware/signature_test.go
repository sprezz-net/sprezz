...
func (m *mockStorageStub) EnqueueInbound(ctx context.Context, id, a, o, t string, p []byte) error {
	return nil
}
func (m *mockStorageStub) ClaimInboundBatch(ctx context.Context, b int) ([]model.InboundTask, error) {
	return nil, nil
}
...
func (m *mockStorageStub) GetNomadicIdentity(ctx context.Context, g string) (*model.NomadicIdentity, error) {
	return nil, nil
}
func (m *mockStorageStub) UpsertNomadicIdentity(ctx context.Context, i *model.NomadicIdentity) error {
	return nil
}
func (m *mockStorageStub) RegisterIdentityClone(ctx context.Context, g, h string, l bool) error {
	return nil
}
func (m *mockStorageStub) GetActorPrivateKey(ctx context.Context, a string) (string, error) {
	return "", nil
}
func (m *mockStorageStub) CreateGraphVersion(ctx context.Context, a, o string, p []byte) (int64, error) {
	return 0, nil
}
...
func (m *mockStorageStub) GetLatestPayload(ctx context.Context, o string) ([]byte, error) {
	return nil, nil
}
func (m *mockStorageStub) StreamQuadsBySubject(ctx context.Context, s string) ([]model.Quad, error) {
	return nil, nil
}
func (m *mockStorageStub) GetCollectionPayloads(ctx context.Context, a, c string, l, o int) ([][]byte, error) {
	return nil, nil
}
func (m *mockStorageStub) RecordActorInboxDelivery(ctx context.Context, actorIRI, activityIRI string) error {
	return nil
}
