...
-- +goose Down
DROP TABLE IF EXISTS actor_media_ownership CASCADE;
DROP TABLE IF EXISTS rdf_graph_attachments CASCADE;
DROP TABLE IF EXISTS media_attachments CASCADE;
DROP TABLE IF EXISTS rdf_quads CASCADE;
DROP TABLE IF EXISTS rdf_graphs CASCADE;
DROP TABLE IF EXISTS rdf_dictionary CASCADE;
DROP TABLE IF EXISTS outbound_activity_queue CASCADE;
DROP TABLE IF EXISTS actor_inbox_deliveries CASCADE;
DROP TABLE IF EXISTS activity_tenant_deliveries CASCADE;
DROP TABLE IF EXISTS inbound_activity_queue CASCADE;
DROP TABLE IF EXISTS local_actor_credentials CASCADE;
DROP TABLE IF EXISTS identity_clones CASCADE;
DROP TABLE IF EXISTS nomadic_identities CASCADE;
DROP TABLE IF EXISTS blocked_domains CASCADE;
DROP TABLE IF EXISTS server_tenants CASCADE;
