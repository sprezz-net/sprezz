...
func TestBNodeRewriter_IsIndependentOfParserIDs(t *testing.T) {
	rewriter := jsonld.NewBNodeRewriter()
	first := []model.Quad{
		{Subject: "_:b0", Predicate: "https://www.w3.org/ns/activitystreams#attachment", Object: "_:b1", ObjType: model.BlankNode},
		{Subject: "_:b1", Predicate: "https://www.w3.org/ns/activitystreams#url", Object: "https://sprezz.net/media/image.png", ObjType: model.NamedNode},
	}
	second := []model.Quad{
		{Subject: "_:parser-17", Predicate: "https://www.w3.org/ns/activitystreams#attachment", Object: "_:parser-42", ObjType: model.BlankNode},
		{Subject: "_:parser-42", Predicate: "https://www.w3.org/ns/activitystreams#url", Object: "https://sprezz.net/media/image.png", ObjType: model.NamedNode},
	}
	...
	for index := range firstResult {
		if firstResult[index].Subject != secondResult[index].Subject || firstResult[index].Object != secondResult[index].Object {
			t.Fatalf("parser-generated blank-node IDs changed the result: %#v != %#v", firstResult, secondResult)
		}
	}
}
